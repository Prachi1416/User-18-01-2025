  ...
  return (
    ...
    <div className='CreateUser w-100 text-center ' style={{backgroundColor:"#43CC9F" ,height:"90vh"}}>
        ...
        <h1 className='text-center text-danger'>Create User</h1>
                ...
                <form onSubmit={handleSubmit(addUserToDB)}>
                    ...
                    <center>
                        <button type="submit" className='btn btn-success col-sm-4 mb-2'>Submit</button>
                        <button type="reset" className='btn btn-warning col-sm-4  mb-2'onClick={ () => {reset()}}>Reset </button>
                    </center>
